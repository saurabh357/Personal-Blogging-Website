...
<header class="s-header">
    ...
    <div class="s-header__logo">
        <a class="logo" href="index.php">
            <h2 style="color:white;font-family:monospace;display:table-cell;padding-top:18px; font-size:25px;">Saurabh</h2>
        </a>
    </div>
    ...
    <div class="row s-header__navigation">
        ...
        <nav class="s-header__nav-wrap">
            ...
            <ul class="s-header__nav">
                <li style="colour:white" class="current"><a href="index.php" title="">Home</a></li>
